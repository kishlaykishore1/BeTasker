...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        Constants.kAppDelegate.window = window
        
        
        if Constants.getAPITokens().accessToken != nil {
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        if let style = UserDefaults.standard.value(forKey: Constants.kUserInterfaceStyle) as? String, let enumStyle = EnumUserInterfaceStyle(rawValue: style) {
            switch enumStyle {
            case .light:
