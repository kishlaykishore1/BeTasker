  ...
  override func drawLine(_ ctx: CGContext) {
    ...
    CircularTrig.drawUnfilledArcInContext(ctx, center: centerPoint, radius: computedRadius, lineWidth: CGFloat(lineWidth), fromAngleFromNorth: CGFloat(angleFromNorth), toAngleFromNorth: CGFloat(upperAngleFromNorth), lineCap: filledArcLineCap)
      ...
      if isFillGradientApply {
          CircularTrig.drawfilledGradientArcInContext(ctx, center: centerPoint, radius: computedRadius, lineWidth: CGFloat(lineWidth), fromAngleFromNorth: CGFloat(angleFromNorth), toAngleFromNorth: CGFloat(upperAngleFromNorth), colors: filledGradientColors, lineCap: filledArcLineCap)
      }
  }
