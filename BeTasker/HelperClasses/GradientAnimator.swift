...
//    let gradientView = GradientAnimator(frame: self.frame, theme: GradientThemes.Sunrise, _startPoint: GradientPoints.left, _endPoint: GradientPoints.right, _animationDuration: 3.0)
